					...
					<div class="sidebar">
                        <div class="sidebar_section">
                            ...
                            <ul class="sidebar_categories">
                                ...
                                <c:forEach var="item" items="${listHangSanPham}">
								...
								<div class="col">
									...
									<div
										...
										<ul class="product_sorting">
											<li><span class="type_sorting_text">Tất cả</span>
											<i class="fa fa-angle-down"></i>
                                            <ul class="sorting_type">
                                                <a href="#"><li class="type_sorting_btn">
                                                    <span>Tất cả</span></li>
                                                </a>
                                                 <c:forEach var="item" items="${listLoaiSanPham}">
                                                  <a href="#"><li class="type_sorting_btn"><span>${item.tenLoai}</span></li></a>
                                                </c:forEach>
                                            </ul></li>
					...
					<div class="row">
						<div class="col-lg-6">
							<div
								...
								<h4>Bảng tin</h4>
								<p>Đăng ký nhận bảng tin để được nhận ưu đãi 15% khi mua
									hàng lần đầu</p>
							</div>
						</div>
						<div class="col-lg-6">
